  ...
  handleLike: function (post) {
    ...
    if (post.user_id != firebase.auth().currentUser.uid) {
      var ref = firebase
        .database()
        .ref(
          "/user-likes/" + firebase.auth().currentUser.uid + "/" + post.post_id
        );
      ref.once("value", (snap) => {
        ...
        updates[
          "/user-posts/" + post.user_id + "/" + post.post_id
        ] = anotherPost;
          ...
          <div key={index} className="post">
              ...
              <tbody>
                <tr>
                  ...
                  <td
                    ...
                    style={{ padding: "0 0 0 5px", verticalAlign: "bottom" }}
                  >
            ...
            <blockquote>
              ...
              <button
                ...
                onClick={this.handleLike.bind(null, post)}
              >
